classdef ntSoftClip_07 < audioPlugin
   ...
   methods
      ...
      function y = process_direct(p, x)
         ...
         for i = 1:n
            y(i, 1) = p.soft_clip_asym(x(i, 1), g_cl_up, g_cl_up_recipr, g_cl_dn, g_cl_dn_recipr, alpha) .* g;
            y(i, 2) = p.soft_clip_asym(x(i, 2), g_cl_up, g_cl_up_recipr, g_cl_dn, g_cl_dn_recipr, alpha) .* g;
         end
      end
      function y = process_iir(p, x)
         ...
         for i = 1:n
            ...
            for j = 1:L
               ...
               acc_cl = [0 0];
               acc_cl(1) = p.soft_clip_asym(y_iir1(1), g_cl_up, g_cl_up_recipr, g_cl_dn, g_cl_dn_recipr, alpha);
               acc_cl(2) = p.soft_clip_asym(y_iir1(2), g_cl_up, g_cl_up_recipr, g_cl_dn, g_cl_dn_recipr, alpha);
      ...
      function y = process_fir(p, x)
         ...
         for i = 1:n
            ...
            for j = 1:L
               ...
               % Clip accumulated value.
               acc_cl = [0 0];
               acc_cl(1) = p.soft_clip_asym(y_fir(1), g_cl_up, g_cl_up_recipr, g_cl_dn, g_cl_dn_recipr, alpha);
               acc_cl(2) = p.soft_clip_asym(y_fir(2), g_cl_up, g_cl_up_recipr, g_cl_dn, g_cl_dn_recipr, alpha);

               % Store to delay line for antialiasing filter.
               p.antialiasing_delay_line(i_store_out, :) = acc_cl;
               p.antialiasing_delay_line(i_store_out + n_dl_out, :) = acc_cl;
